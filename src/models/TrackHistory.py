...
class TrackHistory(db.Model):
    ...
    track_history_id = db.Column(db.Integer, primary_key=True)
    description_id = db.Column(db.String(255), nullable=True)
    synoptic_time = db.Column(db.String(255), nullable=True)
    ...
    def __init__(self, description_id, synoptic_time, latitude, longitude, intensity, created_by, updated_by):
        self.description_id = description_id
        self.synoptic_time = synoptic_time
